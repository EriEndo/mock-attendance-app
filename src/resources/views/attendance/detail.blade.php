...
<form action="{{ route('stamp_correction_request.store', $attendance->id) }}" method="POST">
    ...
    <table class="attendance-detail_table">
        ...
        <tr class="detail__row" data-testid="detail_clock_inout_row">
        ...
        <tr class="detail__row" data-testid="detail_breaks_row_{{ $index }}">
        ...
        <tr class="detail__row" data-testid="detail_note_row">
            <th class="detail__label">備考</th>
            <td class="detail__data" data-testid="detail_note">
